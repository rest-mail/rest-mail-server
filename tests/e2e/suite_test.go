...
var (
	...
	mail3SMTPAddr   = envOr("MAIL3_SMTP_ADDR", "10.99.0.13:25")
	mail1IMAPAddr   = envOr("MAIL1_IMAP_ADDR", "10.99.0.14:143")
	mail2IMAPAddr   = envOr("MAIL2_IMAP_ADDR", "10.99.0.15:143")
	mail3IMAPAddr   = envOr("MAIL3_IMAP_ADDR", "10.99.0.13:143")
	mail1POP3Addr   = envOr("MAIL1_POP3_ADDR", "10.99.0.14:110")
	mail3POP3Addr   = envOr("MAIL3_POP3_ADDR", "10.99.0.13:110")
	mail1SubmitAddr = envOr("MAIL1_SUBMIT_ADDR", "10.99.0.11:587")
	mail3SubmitAddr = envOr("MAIL3_SUBMIT_ADDR", "10.99.0.13:587")
	dnsServerAddr   = envOr("DNS_SERVER_ADDR", "10.99.0.3:53")
